...
!!! example "唯一可消费资源：C50C/F407 麦轮霍尔/serial-can"
    资源目录：`r680/firmware/c50c/f407-mecanum-hall-single-serial-can-b01/`。查看 `USER/WHEELTEC.uvprojx`、`USER/main.c`、`HARDWARE/usartx.c`、`HARDWARE/can.c`。源码固定在 [62aacaed](https://github.com/EnosElinsa/wheeltec-ros-source-reference/tree/62aacaed782091b06060ace276c64e9aaf84ae6b/r680/firmware/c50c/f407-mecanum-hall-single-serial-can-b01)。
