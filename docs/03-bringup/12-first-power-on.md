...
如果 OLED 显示 `TYPE X`，先保存照片并断电。不要立即调整车型电位器或烧录测试固件，因为错误固件、车型设置、编码器接线和电机故障都可能进入同一现象。第 14 章先做分层判断，R680 的具体处理见第 48 章。
...
| R680 显示 `TYPE X` | 保存 OLED 和接线照片，断电 | 第 14 章分层诊断；第 48 章 R680 专项排查 |
