...
理解 ROS 2，需要依次弄清三个问题：ROS 是什么，为什么会从 ROS 1 演进到 ROS 2，以及它在机器人软硬件系统中处于哪一层。
...
**操作系统（Operating System, OS）**管理处理器、内存、文件、网络和设备。Ubuntu 是 WHEELTEC 主控上常见的 OS，ROS 运行在 Ubuntu 提供的环境之中。ROS 负责机器人程序之间的协作，Ubuntu 负责让这些程序获得稳定的计算和设备资源。
...
在 WHEELTEC 教程中，ROS 2 主要承担四类基础工作：
