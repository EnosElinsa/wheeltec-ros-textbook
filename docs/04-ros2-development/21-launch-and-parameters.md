...
需要把顶层入口继续追到 `base_serial.launch.py`、EKF、车型 URDF、雷达和相机分支时，使用 [`turn_on_wheeltec_robot` 源码与启动链导读](21-launch-and-parameters.md#bringup-launch-chain)。导读中的结构是追踪方法，仍应以当前工作空间文件为准。
