...
## 44.5 ROS—串口—固件链 {#ros-serial-firmware-chain}
...
[上一章：修改、编译、烧录与回滚固件](43-build-flash-rollback.md) · [返回本篇](index.md) · [下一章：机器人仿真](../08-advanced-applications/45-gazebo-simulation.md)
