...
先回到第 29 章确认雷达、IMU 和底盘设备数据，再确认定位与里程计节点及其话题。随后检查 TF、时间戳和地图坐标；基础链路通过后，再评估扫描匹配和融合配置。
...
[上一章：激光雷达与二维建图](30-lidar-and-mapping.md) · [返回本篇](index.md) · [下一章：Nav2 导航](32-nav2-navigation.md)
