...
FIXED_TARGETS = (
    ...
    ("docs/07-stm32-firmware/40-firmware-architecture-freertos.md", "firmware-evidence-record"),
    ("docs/07-stm32-firmware/41-hardware-init-model-interfaces.md", "stm32-peripheral-labs"),
    ("docs/07-stm32-firmware/42-motor-control-pid.md", "closed-loop-prechecks"),
    ("docs/07-stm32-firmware/44-ros2-stm32-integration.md", "ros-serial-firmware-chain"),
