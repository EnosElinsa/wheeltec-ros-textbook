...
class PublicSourceReferenceTests(unittest.TestCase):
    ...
    def test_appendix_is_published_but_not_used_as_a_generic_chapter_pointer(self) -> None:
        ...
        related = (
            ...
            "docs/07-stm32-firmware/38-firmware-architecture-freertos.md",
            "docs/07-stm32-firmware/39-hardware-init-model-interfaces.md",
            "docs/07-stm32-firmware/40-motor-control-pid.md",
            "docs/07-stm32-firmware/42-ros2-stm32-integration.md",
            "docs/08-advanced-applications/43-gazebo-simulation.md",
            "docs/08-advanced-applications/44-multi-robot-and-qt.md",
            "docs/08-advanced-applications/45-mmwave-human-deep-learning.md",
            "docs/08-advanced-applications/46-voice-ai-openclaw.md",
            "docs/09-r680-platform/48-r680-debug-source-firmware.md",
            "docs/10-deployment-maintenance/50-logs-backup-upgrade-recovery.md",
